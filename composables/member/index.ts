...
/** 用户信息 */
export const queryUserInfo = (params?: any) => post<IAccountInfo>(getUserInfo, params, true);

/** 获取商品浏览足迹 */
export const queryGoodsBrowsing = (params: any) => post<GoodsBrowsing>(goodsBrowsing, params, true);

/** 获取我的发票列表 */
export const queryUserInvoiceList = (params: any) => post<Array<InvoiceList>>(userInvoiceList, params, true);

/** 取下级地址列表 */
export const queryAreas = (params?: any) => post<Array<Areas>>(getAreas, params);

/** 积分记录 */
export const queryPointLog = (params?: any) => post<Array<PointLog>>(pointLog, params, true);

/** 获取秒杀团购 */
export const querySeckillGroup = (params: any) => post<GroupList>(getGroup, params, false, null, `${getGroup}/${params.type}`);

/** 拼团列表 */
export const queryPinTuanList = (params: any) => post<Array<IpinTuan>>(pinTuanList, params);
...
/** 编辑头像 */
export const editAccountAvatar = (body: { id: string }) => post<string>(changeAvatar, body, true);

/** 编辑用户信息 */
export const editAccountInfo = (body: IAccountInfo) => post(editAccountInfoUrl, body, true)
...
/** 根据用户序列获取门店数据 */
export const queryStoreByUserId = (params?: any) => post(storeByUserId, params, true)

/** 获取单个用户能管理的门店列表 */
export const queryStoreListForUser = (params?: any) => post(storeListForUser, params, true)