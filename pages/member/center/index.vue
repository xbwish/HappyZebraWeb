  ...
  >
    <div class="personal-smg" id="personal-smg">
        ...
        <div v-if="accountStore.getToken" class="header-info">
          <div class="info-text">
            ...
            <section>
              ...
              <nuxt-link
                to="/member/balance/withdrawCash"
                class="link cs-cursor-pointer"
              >
                <CoreshopLanguage :text="$t('我的余额')" />：<span
                  >NT${{ userData.balance }}</span
                >
              </nuxt-link>
      ...
      <div class="my-huiyuan box-shadow">
        <img
          src="/images/huiyuan-level.png"
          style="width: 52px; height: 22px; top: 157px; left: 25px"
          alt=""
        />
        <div class="line"></div>
        <nuxt-link to="/member/integral" class="link cs-cursor-pointer">
        ...
        <nuxt-link to="/member/integral" class="link cs-cursor-pointer">
          <div class="see-detail">
            ...
            >
              <path
                d="M1 0.833313L5 4.49998L1 8.16665"
                stroke="#292B2E"
                stroke-width="1.2"
      ...
      <ul>
        <li v-for="(item, index) in userData.order" :key="index">
          <nuxt-link :to="{ path: '/member/order', query: { status: index } }">
            ...
            <van-badge
              :content="userData.orderSum ? userData.orderSum[index] : 0"
              :show-zero="false"
              color="#D33123"
            >
      ...
      <ul>
        <li v-if="userData.isClerk">
          <nuxt-link to="/member/merchant">
            <NIcon
              class="cs-display-block cs-margin-auto"
              color="#606266"
              :size="25"
            >
...
import type { IOrderStatusSum } from "@/model/order"
