    ...
    <NuxtLayout name="personal-center">
        <div>
            ...
            <div>
                <ul class="store-box">
                    <li>
                        <img :src="storeData.storeInfo.storeLogo ? storeData.storeInfo.storeLogo : '/images/empty.png'"
                            alt="">
                    </li>
                    <li>
                        <div class="icons">
        ...
        <coreshop-canvas-poster :showPopup="storeData.showPopupPoster"
            :link="storeData.link"
            :shareType="UrlSharePageType.agent" :shareOptions="storeData.shareOptions"
...
import { queryAgentGoodsPageList, queryAgentInfo, queryAgentStoreInfo } from '@/composables/agent';
