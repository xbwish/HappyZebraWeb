  ...
  <NuxtLayout name="personal-center">
    ...
    <div>
        ...
        >
          ...
          >
            <div>
              ...
              <p class="cs-font-size-14">
                {{ distributionOrderSumData.orderInfo.allOrder || 0 }}
              </p>
            </div>
            <div
              class="cs-display-flex cs-align-items-center cs-justify-content-space-between"
            >
              <div>
                ...
                <p class="cs-font-size-14">
                  {{ distributionOrderSumData.orderInfo.firstOrder || 0 }}
                </p>
              </div>
              <div>
                <p class="cs-font-size-12 cs-color-gray">
                ...
                <p class="cs-font-size-14">
                  {{ distributionOrderSumData.orderInfo.secondOrder || 0 }}
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <p class="cs-font-size-14">
                {{ distributionOrderSumData.orderInfo.allOrderMoney || "0.00" }}
              </p>
            </div>
            <div
              class="cs-display-flex cs-align-items-center cs-justify-content-space-between"
            >
              <div>
                ...
                <p class="cs-font-size-14">
                  {{
                    distributionOrderSumData.orderInfo.firstOrderMoney || "0.00"
                  }}
                </p>
              </div>
              <div>
                ...
                <p class="cs-font-size-14">
                  {{
                    distributionOrderSumData.orderInfo.secondOrderMoney ||
                    "0.00"
                  }}
                </p>
              </div>
        ...
        >
          ...
          >
            <div>
              ...
              <p class="cs-font-size-14">
                {{ distributionOrderSumData.orderInfo.monthOrder || 0 }}
              </p>
            </div>
          </div>
          <div
          ...
          >
            <div>
              ...
              <p class="cs-font-size-14">
                {{
                  distributionOrderSumData.orderInfo.monthOrderMoney || "0.00"
                }}
              </p>
            </div>
          </div>
      ...
      <div class="tab-box">
        ...
        >
          <Tab
            v-for="item in distributionOrderSumData.statusList"
            :key="item.value"
            :title="item.name"
          />
        </Tabs>
        ...
        <div class="list-box">
          <ul
            v-if="distributionOrderSumData.orderList.length > 0"
            class="cs-m-t-10 cs-font-size-12"
          >
            <li
              v-for="item in distributionOrderSumData.orderList"
              :key="item.id"
          ...
          <p
            class="no-more"
            v-if="
              distributionOrderSumData.orderList.length > 0 &&
              !distributionOrderSumData.haveData
            "
          >
            {{ $t("没有更多了") }}
          </p>
...
const getDistributionOrderSum: Result<AgentOrder> =
  await queryDistributionOrderSum()
...
const query = async () => {
  ...
  if (getDistributionOrder.data.length > 0) {
    distributionOrderSumData.orderList =
      distributionOrderSumData.orderList.concat(getDistributionOrder.data || [])
  } else {
