          ...
          <li>
            <div class="number">
              ...
              >
                ...
                <span
                  class="copy"
                  @click="handleCopy(item.ticket.redeemCode)"
                  >{{ $t("复制核销码") }}</span
                >
              </p>
            </div>
            <div class="goods">
              ...
              >
                ...
                <p class="order-num">
                  {{ $t("核销时间") }}：{{ item.ticket.verificationTime }}
                </p>
                <p class="order-num">
                  {{ $t("核销码") }}：{{ item.ticket.redeemCode }}
                </p>
              </div>
            </div>
            <div class="date">
              <p>
                {{ $t("下单时间") }}：{{
                  timeFormat(item.ticket.createTime, "mm-dd hh:MM:ss")
                }}
              </p>
              <CoreshopButton
                size="small"
