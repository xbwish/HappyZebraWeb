        ...
        <div style="padding-bottom: 1.5rem;">
            <div class="detail-box">
                <CoreshopGoodDetailProductInfo :goodDetail="detailData.goodsInfo" :chooseSku="detailData.chooseSku"
                    :serviceDescription="detailData.serviceDescription" :sharePageType="UrlSharePageType.group"
                    ...
                    <template #countdown>
                        <div class="cs-font-size-12 cs-color-gray  cs-display-flex cs-align-items-center">
                            ...
                            <van-count-down :time="detailData.goodsInfo?.groupTimestamp * 1000"
                    ...
                    <template #meta>
                        <ul class="cs-display-flex cs-text-align-center cs-justify-content-space-between">
                            <li>
                                <CoreshopLanguage :text="$t('销量')" />: <a href="javascript:;">{{ detailData.goodsInfo?.buyCount ||
                                    '0' }}</a>
                            </li>
                            <li>
                ...
                <!-- 商品详情 -->
                <CoreshopGoodDetailProductDetailAndEvaluate :id="route.query.id" :goodParams="detailData.goodParams"
                ...
                <CoreshopGoodDetailProductSku :show="detailData.showSku" :goodDetail="detailData.goodsInfo"
                    ...
                    <template #button>
                        <div
                            ...
                            <CoreshopButton class="cs-percent-w-100" bg-color="#e84f5d" :size="btnSize.medium"
...
const handleBuyNow = async (event: Event) => {
    ...
    navigateTo(`/order/submit?cartIds=${result.data}&orderType=${OrderTypeEnum.group}&objectId=${detailData.goodsInfo?.groupId}`);
}
