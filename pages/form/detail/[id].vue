    ...
    <div class="layout-form">
      ...
      <div class="banner-box">
        <div v-if="formDetial.headType == 3">
          <video
            class="carousel-img"
            :src="formDetial.headTypeVideo"
            :poster="formDetial.headTypeValue"
          ></video>
        </div>
        ...
        <div
          class="description cs-display-flex cs-align-items-center cs-justify-content-space-between"
        >
          <p>{{ formDetial.description }}</p>
          <CoreshopShare
            :wxShare="formState.wxShare"
            :shareParams="formState.shareParams"
          />
        </div>
      </div>
      ...
      <div class="form-centent">
        <div v-for="item in formDetial.items" :key="item.id">
          <div class="cs-m-b-5" v-if="item.type == FormType.goods">
            <CoreshopFormGoods
              :data="item"
              @handleConfirm="handleGoodsConfirm"
