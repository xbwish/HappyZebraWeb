<template>
  <NuxtLayout name="personal-center">
    ...
    <div v-if="formState.list.length > 0">
      <div
        class="cs-p-10 cs-background-color-white cs-m-b-10 form-item"
        v-for="item in formState.list"
        :key="item.id"
      >
        <NuxtLink
    ...
    <p class="no-more" v-if="formState.list.length > 0 && !formState.haveData">
      {{ $t("没有更多了") }}
    </p>
