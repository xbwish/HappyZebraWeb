        ...
        <NCarousel dot-placement="right" :show-arrow="false">
          <div
            :class="[
              {
                detailLunBoActive:
                  productDetailState.video == props.goodDetail.video,
              },
              'img-box',
            ]"
          ...
          >
            <video
              :src="props.goodDetail.video"
              class="carousel-img cs-cursor-pointer"
              :controls="true"
              @click="handleClickVideo(props.goodDetail.video as string)"
            ></video>
          </div>
          <div
            :class="[
              {
                detailLunBoActive:
                  item == productDetailState.chooseProductImage,
              },
              'img-box',
            ]"
            v-for="item in productDetailState.imageArr"
            :key="item"
          >
            <img
              class="carousel-img cs-object-fit-contain"
              :src="item"
