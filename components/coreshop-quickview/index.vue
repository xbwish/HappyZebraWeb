<template>
  ...
  >
    <template #meta>
      <ul class="product__meta">
        <li class="product__meta-availability">
          运费: <span class="text-success">包邮</span>
        </li>
        <li>
          销量: <a href="">{{ goodDetail?.buyCount || "0" }}</a>
        </li>
    ...
    <template #button>
      ...
      <div
        class="product__actions-item product__actions-item--addtocart cs-flex-1"
      >
        <button
          class="btn btn-secondary btn-lg cs-percent-w-100"
      ...
      >
        <button
          class="btn btn-primary btn-lg cs-percent-w-100"
