...
export const wxShare = async ({ title, desc, link, imgUrl, callback = () => { } }: IWxShare) => {
    ...
    scriptNode.setAttribute('src', 'https://res2.wx.qq.com/open/js/jweixin-1.6.0.js')
    document.body.appendChild(scriptNode); 
    
    const { appId, nonceStr, signature, timestamp } :Result<WxJsApi> = await queryJsapi({
